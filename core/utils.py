...
def recognize_plate(img, coords):
    ...
    rect_kern = cv2.getStructuringElement(cv2.MORPH_CROSS, (6, 1))
    # apply dilation to make regions more clear
    dilation = cv2.dilate(thresh, rect_kern, iterations=10)
    ...
    for cnt in sorted_contours:
        ...
        try:
            text = pytesseract.image_to_string(roi,
                                               config='-c tessedit_char_whitelist=0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ --psm 9 --oem 3')
