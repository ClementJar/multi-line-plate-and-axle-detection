...
flags.DEFINE_string('weights', './checkpoints/yolov4-license-plate-416',
                    'path to weights file')
flags.DEFINE_integer('size', 416, 'resize images to')
flags.DEFINE_boolean('tiny', False, 'yolo or yolo-tiny')
flags.DEFINE_string('model', 'yolov4', 'yolov3 or yolov4')
flags.DEFINE_string('video', 'rtsp://cbuibic:admin1234@192.168.8.8:554/Streaming/Channels/1', 'path to input video or set to 0 for webcam')
