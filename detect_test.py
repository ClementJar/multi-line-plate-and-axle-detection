...
def main(_argv):
    ...
    for count, image_path in enumerate(images, 1):
        ...
        bboxes = utils.format_boxes(boxes.numpy()[0], original_h, original_w,False)
        ...
        if FLAGS.crop:
            crop_path = os.path.join("C:\\app_upload\\vtms\\uploads\\tempVehicleDetails", ip_address)
            try:
                os.mkdir(crop_path)
        ...
        image, plate_number = utils.draw_bbox(original_image, pred_bbox, FLAGS.info,
