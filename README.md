...
python detect_video.py --weights ./checkpoints/yolov4-License-Plate-416 --size 416 --model yolov4 --video ./data/video/license_plate.mp4 --output ./detections/recognition.avi --plate
```
